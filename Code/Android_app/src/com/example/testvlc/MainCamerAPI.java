...
public class MainCamerAPI extends AppCompatActivity 
{
    ...
    protected void createCameraPreview()
    {
        try
        {
            ...
            cameraDevice.createCaptureSession(Arrays.asList(surface), new CameraCaptureSession.StateCallback()
            {
                ...
                {
                	Toast.makeText(MainCamerAPI.this, "Configuration change", Toast.LENGTH_SHORT).show();
                }
             }, null);
        }
        catch (CameraAccessException e)
    ...
    private void openCamera() 
    {
        ...
        try
        {
            ...
            {
                ActivityCompat.requestPermissions(MainCamerAPI.this, new String[]{Manifest.permission.CAMERA, Manifest.permission.WRITE_EXTERNAL_STORAGE}, REQUEST_CAMERA_PERMISSION);
                return;
            }
    ...
    public void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions, @NonNull int[] grantResults) 
    {
        if (requestCode == REQUEST_CAMERA_PERMISSION) 
        {
           ...
           {    // close the app
                Toast.makeText(MainCamerAPI.this, "Can't use this app without granting permission", Toast.LENGTH_LONG).show();
                finish();
           }
        }
    }
